    ...
    >
      ...
      >
        <a-row :gutter="24">
          ...
          >
            <a-form-item v-if="i.name!=='分类' && i.name!=='精选' && i.name!=='审核'" :label="`${i.name}`">
              <a-input
                v-decorator="[
                  `${i.field}`,
                  {
  ...
  methods: {
    ...
    getList: async function () {
      ...
      for (let i = 0; i < this.data.length; i++) {
        ...
        this.data[i].createAt = moment('2019-04-28T06:54:31.914Z').format('YYYY-MM-DD HH:MM')
      }
    },
