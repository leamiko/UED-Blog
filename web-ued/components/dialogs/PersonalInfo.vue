<template>
  <el-dialog :visible.sync="show"
             width="610px"
             :custom-class="classStyle"
             :before-close="handleClose"
             destroy-on-close
             append-to-body>
    <img src="@/assets/img/bg/bg-dialog-info.png"
         slot="title"
         class="dialog-img">
    <div class="content_block">
      ...
      <div class="cus-flex cus-align-center">
        <div class="avator_list"
          ...
          <img class="selected"
               src="../../assets/img/icon/avator-checked.png"
               alt=""
               v-if="item.isSelect">
        </div>
      </div>
