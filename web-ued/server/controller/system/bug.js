...
// bug条目更新
exports.UpdateBugById = function (req, res, next) {
    var id = req.body.id
    var update = req.body
...
// bug条目删除
exports.DeleteBugById = function (req, res, next) {
    var id = req.body.id
...
// 新增关键词
exports.AddBugKeywords = function (req, res, next) {
...
// 获取所有关键词
exports.GetAllBugKeywords = function (req, res, next) {
