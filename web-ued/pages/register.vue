  ...
  methods: {
    ...
    wxHandle () {
      var obj = new WxLogin({
        ...
        state: "",
        style: "",
        href: "data:text/css;base64,LmltcG93ZXJCb3ggLnFyY29kZXsNCiAgd2lkdGg6IDE4MHB4Ow0KICBoZWlnaHQ6IDE4MHB4Ow0KICBtYXJnaW4tdG9wOiAwcHg7DQogIG1hcmdpbi1yaWdodDogMTE4cHg7DQp9DQouaW1wb3dlckJveCAuaW5mb3sNCiAgZGlzcGxheTogbm9uZTsNCn0NCi5pbXBvd2VyQm94IC50aXRsZXsNCiAgZGlzcGxheTogbm9uZTsNCn0="
      });
    },
    //注册框隐藏登录框显示
    Visible () {
