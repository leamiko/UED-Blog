  ...
  <div class="container">
    ...
    <div class="top_article">
      <el-carousel trigger="click"
        ...
        <el-carousel-item v-for="(item,index) in topList"
                          :key="index"
                          class="flex">
          <div class="left_title"
               @click="goDetail(item.blog)">
            <img :src="item.blog.bigImgUrl"
                 :style="{'visibility': item.blog.bigImgUrl ? 'visible': 'hidden'}">
          </div>
          <div class="right_detail"
               @click="goDetail(item.blog)">
            <img :src="require('../../assets/img/image/' + item.blog.imgUrl)"
                 alt="">
            <div class="title">
              <p>{{item.blog.title}}</p>
            </div>
    ...
    <div class="other_article">
      ...
      <div class="right_articles"
           v-infinite-scroll="getWriteList"
        ...
        <div class="article_block"
          ...
          <div>
            ...
            <p>
              <img v-if="!item.userInfo[0].avatar"
                   class="author_icon"
              ...
              <span class="thumb_amount">
                <img src="../../assets/img/icon/icon-thumb-up.svg"
                     alt="">
                {{item.likeNum}}
              </span>
            </p>
        ...
        <div class="no_result"
             v-if="lists.length == 0">
          <img src="../../assets/img/image/img-write-blank.png"
               alt="">
